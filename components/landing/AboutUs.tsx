...
const features = [
  { title: "Innovation", description: "Cutting-edge technology and latest devices" },
  { title: "Support", description: "Expert guidance and lifetime technical assistance" },
  { title: "Reliability", description: "Premium quality and trusted warranties" },
]
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="relative">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-heading1-bold text-zinc-900">About {Store.name}</h2>
              <p className="text-body-medium text-zinc-600">
                We curate collections that combine innovation, performance, and reliability. Our devices and accessories
                are designed for those who value quality and cutting-edge technology in every detail.
              </p>
            ...
            >
              ...
              <div className="absolute -bottom-6 -left-6 w-48 h-48 border border-zinc-200 rounded-lg flex items-center justify-center p-4 bg-white/80 backdrop-blur-sm">
                <p className="text-center text-base-semibold text-zinc-900">Innovating technology with excellence</p>
              </div>
            </motion.div>
          </div>
        </div>
